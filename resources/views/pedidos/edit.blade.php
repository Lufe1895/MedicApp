                ...
                <div class="card-body">
                    <form action="{{ url('/pedidos/'.$pedido->id) }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="address" value="{{ $pedido->address }}" required autocomplete="last_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control" name="phone" value="{{ $pedido->phone }}" required autocomplete="last_name" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="total" class="col-md-4 col-form-label text-md-right">{{ __('Receta') }}</label>

                            <div class="col-md-6">
                                <input id="total" type="number" class="form-control" name="total" value="{{ $pedido->total }}" autofocus>
