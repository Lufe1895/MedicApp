            ...
            <div class="card-body">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card mb-3">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title font-weight-bold">{{ $pharmacy->name }}</h5>
                ...
                <div class="btn-group">
                    ...
                    @if(auth()->user()->hasRole('admin'))
                        <a href="{{ url('/pharmacies') }}" class="btn btn-info"><i class="fas fa-chevron-left"></i> &nbsp; <span class="d-none d-sm-inline">Volver a la Lista</span></a>
                    @endif
                </div>
            </div>
        </div>
